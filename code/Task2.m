...
alt0 = 3.0;          
filePath = 'C:\Users\17863\OneDrive\文档\项目\0-polyu课程\1-PhD课程\AAE6102卫星导航课\assignment2\Assignment2-main\navSolutions_urban.mat';
...
% Load SkyMask data
M = readmatrix('C:\Users\17863\OneDrive\文档\项目\0-polyu课程\1-PhD课程\AAE6102卫星导航课\assignment2\Assignment2-main\SkyMask_A1_urban.csv');
...
figure;
plot(0:360, SkyMask.SkyMaskElVec, 'r', 'LineWidth',1.5)
xlabel('Azimuth (°)')
...
% Plot results
figure;
plot(lon, lat, 'b.', 'MarkerSize', 10); % Estimated positions
